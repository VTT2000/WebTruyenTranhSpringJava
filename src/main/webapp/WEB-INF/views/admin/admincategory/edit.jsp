                    ...
                    <div class="card card-primary">
                      ...
                      <!-- /.card-header -->
                          <form method="POST" action="../admin/category_edit" >
                                <input name="IDcatergory" value="${ temp.IDcatergory }" type="hidden" />
                              <div class="card-body">
                                <div class="form-group">
                                  <label for="0">Tên thể loại</label>
                                  <input value="${temp.catergory }" id="0" type="text" class="form-control" name="catergory" placeholder="Tên thể loại"/>                            
                                </div>
                                <div class="form-group">
